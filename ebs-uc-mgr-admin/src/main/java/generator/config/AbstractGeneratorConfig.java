...
import com.yestae.user.manage.core.template.config.ContextConfig;
import com.yestae.user.manage.core.template.engine.SimpleTemplateEngine;
import com.yestae.user.manage.core.template.engine.base.GunsTemplateEngine;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void init() {
        ...
        packageConfig.setService("com.yestae.user.manage.modular." + contextConfig.getModuleName() + ".service");
        packageConfig.setServiceImpl("com.yestae.user.manage.modular." + contextConfig.getModuleName() + ".service.impl");
