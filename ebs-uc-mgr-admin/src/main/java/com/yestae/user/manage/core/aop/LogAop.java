package com.yestae.user.manage.core.aop;
...
import com.yestae.user.manage.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.yestae.user.manage.common.annotion.BussinessLog)")
    ...
    private void handle(ProceedingJoinPoint point, Object result) throws Exception {
        ...
        //如果涉及到修改,比对变化
        String msg;
        if("true".equals(annotation.json())){
        	Map<String, String> parameters = HttpKit.getRequestParameters();
        	parameters.put("result", result.toString());
        	msg = JSONUtils.toJSONString(parameters);
        }else{
