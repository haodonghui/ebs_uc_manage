package com.yestae.user.manage.core.intercept;
...
@Aspect
@Component
@ConditionalOnProperty(prefix = "uc-mgr", name = "session-open", havingValue = "true")
public class SessionTimeoutInterceptor extends BaseController {

	@Pointcut("execution(* com.yestae.user.manage.modular.privilege.controller.*.*(..)) "
    		+ "or execution(* com.yestae.user.manage.modular.system.controller.*.*(..))")
