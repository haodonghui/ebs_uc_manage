...
public class ContextConfig {
    ...
    private String modelPackageName = "com.yestae.user.manage.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.yestae.user.manage.common.persistence.dao";  //model的dao
