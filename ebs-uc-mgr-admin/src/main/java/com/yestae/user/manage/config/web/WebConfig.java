...
import com.yestae.user.manage.core.listener.ConfigListener;
import com.yestae.user.manage.core.xss.XssFilter;
...
public class WebConfig {
    ...
    public JdkRegexpMethodPointcut druidStatPointcut(){
        ...
        String patterns = "com.yestae.user.manage.modular.*.service.*";
        //可以set多个
