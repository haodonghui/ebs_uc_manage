...
public class ServiceConfig {
    ...
    public void init() {
        ...
        this.servicePathTemplate = "\\src\\main\\java\\com\\yestae\\user\\manage\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\yestae\\user\\manage\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.yestae.user.manage.modular." + contextConfig.getModuleName() + ".service";
    }
