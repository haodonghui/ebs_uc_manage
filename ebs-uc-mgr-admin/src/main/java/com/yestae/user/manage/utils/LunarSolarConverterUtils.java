...
public class LunarSolarConverterUtils {
	...
	public static void main(String[] args) {
		...
		solar.solarDay = 20;
		solar.solarMonth = 05;
		solar.solarYear = 1988;
		/**
		 * 公历转农历
		 */
		Lunar lunar1 = LunarSolarConverterUtils.SolarToLunar(solar);
		System.err.println(lunar1);

		Lunar lunar = new Lunar();
		lunar.isleap = false;
		lunar.lunarDay = 05;
		lunar.lunarMonth = 04;
		lunar.lunarYear = 1988;
		/**
		 * 农历转公历
		 */
		Solar solar2 = LunarSolarConverterUtils.LunarToSolar(lunar);
		System.err.println(solar2);
	}
}
