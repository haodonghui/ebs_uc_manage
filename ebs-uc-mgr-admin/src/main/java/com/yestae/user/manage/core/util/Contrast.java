...
import com.yestae.user.manage.common.constant.dictmap.base.AbstractDictMap;
import com.yestae.user.manage.common.constant.dictmap.factory.DictFieldWarpperFactory;
...
public class Contrast {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastObj(Class<? extends Object> dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastObjByName(Class<? extends Object> dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
        AbstractDictMap dictMap = (AbstractDictMap) dictClass.newInstance();
        String str = parseMutiKey(dictMap, key, pojo2) + separator;
        try {
            Class<? extends Object> clazz = pojo1.getClass();
