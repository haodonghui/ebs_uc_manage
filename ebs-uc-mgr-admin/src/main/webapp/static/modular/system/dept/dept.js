...
Dept.initColumn = function () {
    return [
       ...
       // {title: 'id', field: 'id', align: 'center', valign: 'middle',width:'50px'},
        {title: '部门简称', field: 'simplename', align: 'center', valign: 'middle', sortable: true, width:'20%'},
        {title: '部门全称', field: 'fullname', align: 'center', valign: 'middle', sortable: true, width:'20%'},
        {title: '排序', field: 'num', align: 'center', valign: 'middle', sortable: true, width:'20%'},
        {title: '备注', field: 'tips', align: 'center', valign: 'middle', sortable: true, width:'40%'}];
};
