...
Sale.formParams = function () {
    ...
    queryData['channelCode'] = Sale.SHCC;
...
$(function () {
    ...
    Feng.initSelect("channelId", "/yestaeGeneralizeChannel/list/DYCT", {"pcode": Sale.SHCC}, "name", "id", null);
    Feng.initSelect("generalizeUserId", "/yestaeGeneralizeUser/list/DYCT", {"channelCode": Sale.SHCC}, "name", "id", null);
    $("#channelId").change(function(){
    	Feng.initSelect("generalizeUserId", "/yestaeGeneralizeUser/list/DYCT", {"channelCode": Sale.SHCC, channelId: $(this).val()}, "name", "id", null);
	})
});
