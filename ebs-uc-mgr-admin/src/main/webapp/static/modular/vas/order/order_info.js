...
OrderInfoDlg.collectData = function() {
    this.set('id').set('userId').set('addedServiceId').set('name').set('mobile').set('orderNo').set('payNo').set('payAmount').
    		set('payPt').set('payOrderNo').set('payType').set('currency').set('curRate').set('initPayTime').set('finishPayTime').set('notifyPayTime').
    		set('payState').set('createYear').set('orderState').set('orderType').set('createTime').set('updateTime');
}
/**
 * 验证数据
 */
